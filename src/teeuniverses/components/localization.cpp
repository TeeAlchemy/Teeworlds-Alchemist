...
CLocalization::CLanguage::CLanguage() : m_Loaded(false),
...
CLocalization::CLanguage::CLanguage(const char *pName, const char *pFilename, const char *pParentFilename) : m_Loaded(false),
																											 m_Direction(CLocalization::DIRECTION_LTR),
																											 m_pPluralRules(NULL),
																											 m_pNumberFormater(NULL),
																											 m_pPercentFormater(NULL)
...
/* BEGIN EDIT *********************************************************/
CLocalization::CLocalization(class CStorage *pStorage) : m_pStorage(pStorage),
