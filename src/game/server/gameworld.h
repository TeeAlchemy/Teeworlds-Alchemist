...
public:
	enum
	{
		...
		ENTTYPE_JET,
		ENTTYPE_TANK,
		ENTTYPE_VEHICLE_GRENADE,
		ENTTYPE_VEHICLE_MISSILE,
		ENTTYPE_BUILDINGS,
		ENTTYPE_BUILDINDICATOR,
		ENTTYPE_BATTLE_C4,
		ENTTYPE_BATTLE_C4_GRENADE,
		ENTTYPE_BATTLE_MINE,
		ENTTYPE_BATTLE_SMOKE,
		ENTTYPE_BATTLE_HEALTH_STATION,
		ENTTYPE_BATTLE_WEAPON_PACK,
		ENTTYPE_BATTLE_LASER_DOOR,
		ENTTYPE_BATTLE_LASER_SWITCH,
		ENTTYPE_BATTLE_AA_GUN,
		ENTTYPE_BATTLE_PORTAL,
		ENTTYPE_BATTLE_AMMO_PACK,
		ENTTYPE_BATTLE_HEART,
		ENTTYPE_MOTORCYCLE,
		ENTTYPE_BOAT,
		ENTTYPE_SUBMARINE,
		ENTTYPE_SKATEBOARD,
...
public:
	...
	*/
	...
	class CCharacter *LaserIntersectCharacter(vec2 Pos0, vec2 Pos1, float Radius, vec2 &NewPos, class CCharacter *pNotThis[MAX_CLIENTS]);
