...
function build(settings)
    ...
    teeuniverses = Compile(server_settings, Collect("src/teeuniverses/*.cpp", "src/teeuniverses/components/*.cpp",
        "src/teeuniverses/system/*.cpp"))
    alchemy = Compile(server_settings, Collect("src/alchemy/*.cpp"))
    ...
    -- build server
    server_exe = Link(server_settings, "teeworlds_srv", engine, server, game_shared, game_server, zlib, md5, sqlite3,
        server_link_other, json, teeuniverses, alchemy)
